...
<div className="grid grid-cols-2 gap-16 justify-center items-center text-white">
           {
                actor.map((actor) => (
                    ...
                    <h3 className="text-2xl font-semibold my-5">Country: {actor.country}</h3>
                    <div className="flex justify-between mb-7">
                        <h3 className="text-xl font-semibold pl-7">Salary: {actor.salary}$</h3>
                        <h3 className="text-xl font-semibold pr-7">Role: {actor.role}</h3>
                    </div>
                   <div className="mb-10">
